...
namespace ChessLibrary
{
    public class ChessGame
    {
        ...
        {
            Square? selectedSquare = Board.GetSquare(squarePosition);
            if (selectedSquare == null) return MoveSquareResult.InvalidMoveFormat;
            Move? move = null;
        ...
        public List<Move> GetAllLegalMoves()
        {
            ...
            foreach (var square in Board.GetAllAllySquares(Turn))
            {
                var legalMoves = validator.GetLegalMoves(square);
        ...
        public List<Move> GetAllLegalMoves(PieceTeam team)
        {
